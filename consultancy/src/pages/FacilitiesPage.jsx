...
export default function VisionMissionPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-100 via-white to-blue-50 text-gray-900 p-10 flex justify-center items-center">
      <motion.section
      ...
      >
        <h1 className="text-5xl font-extrabold text-blue-800 mb-12 tracking-wide drop-shadow-md">
          Our Vision
        </h1>
...
function VisionCard({ item, index }) {
  return (
    <motion.div
      ...
      whileHover={{ scale: 1.08, translateY: -5, boxShadow: "0px 10px 25px rgba(59, 130, 246, 0.3)" }}
      className="relative bg-white bg-opacity-90 backdrop-blur-2xl rounded-2xl shadow-lg p-6 flex flex-col items-center text-center border border-gray-200 transition-all duration-300 hover:shadow-xl hover:border-blue-400 w-64"
    >
      ...
      <h2 className="text-xl font-semibold text-blue-700 mt-4 tracking-wide">{item.title}</h2>
