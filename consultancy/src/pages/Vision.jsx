...
const Vision = () => {
  return ( 
    <div class="vision-container1">
<div class="card1">
    <div class="border1"></div>
    <div class="content1">
      <div class="logo1">
        <div class="logo11">
          <svg viewBox="0 0 29.667 31.69" xmlns="http://www.w3.org/2000/svg" id="logo-main1">
        ...
        <div class="logo21">
          <svg viewBox="0 0 101.014 23.535" xmlns="http://www.w3.org/2000/svg" id="logo-second2">
        ...
        <span class="trail1"></span>
      </div>
      <span class="logo-bottom-text1">uiverse.io</span>
    </div>
    <span class="bottom-text1">universe of ui</span>
  </div>
  </div>
  );
};
